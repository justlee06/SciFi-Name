...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        String name_first = firstName.toUpperCase().charAt(0) + firstName.substring(1, 3) + lastName.substring((lastName.length() - 2));
        String name_last = city.toUpperCase().charAt(0) + city.substring(1, 2) + school.substring(0, 3);
        int num = (int)(Math.random() * (relativeName1.length() - 1));
        int num2 = (int)(Math.random() * (relativeName2.length() - 1));
        String origin = relativeName1.substring(num).toUpperCase().charAt(0) + relativeName1.substring(num + 1) + relativeName2.substring(num2);
        System.out.println("Hello " + name_first + " " + name_last + " of " + origin + ". Welcome!");
    }
}
